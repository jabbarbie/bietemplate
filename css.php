...
.copyright {
  flex: 0 50%;
  /*border-top: 1px var(--colorForget) solid;*/
  text-align: left;
  font-size: 0.5em; 
  margin-left: 1%;
}
...
.sebelum {background-color: var(--colorSecond); float: left}
.sesudah {background-color: var(--colorHover); float: right}
.clear {clear: both}
aside .AdSense {
...
#startx .kiri {
  color: var(--colorHover);
  text-align: right;
  border-left: 3px solid var(--colorHover);
  border-top: 3px solid var(--colorHover);
  border-bottom: 3px solid var(--colorHover);
}
#startx .kanan {
  color: var(--colorSecond);
  border-top: 3px solid var(--colorSecond);
  border-right: 3px solid var(--colorSecond);
  border-bottom: 3px solid var(--colorSecond);
}
#startx .kiri a {color: var(--colorHover);}
#startx .kanan a {color: var(--colorSecond);}
...
/*.rekomendasilabel {margin-right: 3px}*/
.rekomendasilabel:after {content: ' - '}
